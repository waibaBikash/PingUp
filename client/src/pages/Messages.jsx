                    ...
                    <img src={user.profile_picture} alt="" className='rounded-full size-12 mx-auto' />
                      <div className='flex-1'>
                       ...
                       <div className='flex flex-col gap-2 mt-4'>
                          <button onClick={()=> navigate(`/message/${user._id}`)} className='size-10 flex items-center justify-center text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 active:scale-95 transition cursor-pointer gap-1'>
                             <MessageSquare />
                          </button>
